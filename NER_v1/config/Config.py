...
def arg_conf():
    ...
    parser.add_argument("--hidden_size", type=int, default=200, help="rnn hidden size")
    ...
    parser.add_argument("--char_embed_dim", type=int, default=200, help="char hidden_size")
